...
export class McpService {
    ...
    getBaseUrl;
    stdioTransport;
    constructor(reviewManager, getBaseUrl) {
    ...
    请在浏览器中完成审核，完成后在终端输入 'continue'，然后调用 get_review_result 获取结果。` }]
        ...
        */
        ...
        this.server.tool("get_review_result", `获取人工审核的结果。
...
- updated: 等待用户审核新版本`, {
        ...
        this.server.tool("ask_questions", `Ask questions or acknowledge comments from user feedback.
